...
- (void)viewDidLoad {
    ...
    self.navigationBar.titleTextAttributes = @{NSForegroundColorAttributeName:[UIColor colorWithHexString:@"0f3649"],NSFontAttributeName:[UIFont systemFontOfSize:18]};
}
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    if (self.childViewControllers.count > 0) { // 如果viewController不是最早push进来的子控制器
        ...
        [backButton setTitleColor:[UIColor colorWithHexString:@"0f3649"] forState:UIControlStateNormal];
